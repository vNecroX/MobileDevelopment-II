...
public class ListadoBosquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado_bosques);
        ...
        Cursor registro = bd.rawQuery("select * from bosques ", null);
        ...
        if(n > 0){
            ...
            Toast.makeText(this, "Sin registro de Bosques.", Toast.LENGTH_SHORT).show();
        }
        //Cerrando la BD
        bd.close();
    }
    ...
    public void regresarPrincipal(View view){
        /*Intent intent = new Intent(getApplicationContext(), GestionBosquesActivity.class);
